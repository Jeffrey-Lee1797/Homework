...
======
    ...
    ## 1 Aelurodon Aelurodon_asthenostylus 14.7850 18.2000
    ## 2 Aelurodon         Aelurodon_ferox  9.2500 14.7850
    ## 3 Aelurodon       Aelurodon_mcgrewi 14.1815 14.7850
    ## 4 Aelurodon   Aelurodon_montanensis 14.7850 14.7850
    ## 5 Aelurodon      Aelurodon_stirtoni 11.9500 14.7850
    ## 6 Aelurodon      Aelurodon_taxoides  7.6000 14.1815
...
1.  How many unique fossil species are in this family?
...
1.  How many unique fossil genera are in this family?
...
1.  What species has the longest genera?
...
<!-- -->
    ...
    ## Cormocyon_copei 14.3685 Million years
...
=======
    ...
    ##          genus                       species  minage  maxage
    ## 1 Adelpharctos Adelpharctos_n._sp._ginsburgi 25.7150 25.7150
    ## 2 Agriotherium            Agriotherium_?_sp.  4.4665  4.4665
    ## 3 Agriotherium        Agriotherium_africanum  3.0940  4.9170
    ## 4 Agriotherium   Agriotherium_cf._schneideri  3.3500  7.6000
    ## 5 Agriotherium          Agriotherium_insigne  2.8940  2.8940
    ## 6 Agriotherium      Agriotherium_intermedium  3.7000  3.7000
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-9-1.png)
...
<!-- -->
    ...
    ## Ursidae_indet. 18.142 Million years
...
===================
    ...
    ## Warning in `[<-.factor`(`*tmp*`, ri, value = structure(c("2", "5", "3", :
...
gapminder is a data frame with columns that read: 1704 rows and 6
columns. Country and Continent are factors. Year is an integer vector.
...
gapminder\[1:20, \] subsets the data to give the first 20 rows and all
columns.
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-76-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-77-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-78-1.png)

    ggplot(data = gapminder, aes(x=year, y=lifeExp, by=country, color=continent)) +
      geom_line()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-79-1.png)

    ggplot(data = gapminder, aes(x=year, y=lifeExp, by=country, color=continent)) +
      geom_line() + geom_point()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-80-1.png)

    ggplot(data = gapminder, aes(x=year, y=lifeExp, by=country)) +
      geom_line(aes(color=continent)) + geom_point()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-81-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-82-1.png)

    ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp, color=continent)) +
      geom_point()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-83-1.png)

    ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
      geom_point(alpha = 0.5) + scale_x_log10()

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-84-1.png)

    ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
      geom_point() + scale_x_log10() + geom_smooth(method="lm")

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-85-1.png)

    ggplot(data = gapminder, aes(x = gdpPercap, y = lifeExp)) +
      geom_point() + scale_x_log10() + geom_smooth(method="lm", size=1.5)

![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-86-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-87-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-88-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-89-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-90-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-91-1.png)
